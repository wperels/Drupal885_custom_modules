...
/**
 * Class MissionListBuilder
 */
class MissionListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new MissionListBuilder object.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\mission\Entity\MissionEntityInterface $entity */
