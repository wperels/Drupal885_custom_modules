...
class MissionTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\mission\Entity\MissonTypeEntity::load',
      ],
  ...
  /**
   * {@inheritdoc}
   *  The procedural functions drupal_set_message() has been   
   *  deprecated. Replaced with a global Messenger service.
   */
